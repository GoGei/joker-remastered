...
from Api.v1.Jokes.views import JokesViewSet, LikedJokesViewSet, FavouriteJokesViewSet
...
router_v1.register('jokes-favourite', FavouriteJokesViewSet, basename='jokes-favourite'),
